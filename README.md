...
- Includes a **Runner Game** built using a JavaScript class-based game engine with physics, collision detection and scoring
...
| JavaScript (ES6+) | Interactivity, DOM manipulation, game engine |
...
├── script.js       ← JavaScript for all interactive demos
└── .github/
    └── workflows/
